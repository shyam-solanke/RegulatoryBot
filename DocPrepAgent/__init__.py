...
def main(req: func.HttpRequest) -> func.HttpResponse:
    try:
        ...
        Task: You are a helpful AI assistant that answers questions regarding the FDA devices and drugs processes. Do a web search to https://www.fda.gov/medical-devices/device-advice-comprehensive-regulatory-assistance/medical-device-databases url to answer the questions.
